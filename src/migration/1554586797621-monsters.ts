...
export class Migration1554586797621 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    queryRunner.query(`
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Blue Slime',1,4,2,30,1,1,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Red Slime',1,6,2,28,2,1,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Splinter',2,5,3,31,1,4,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Black Rat',2,7,1,35,3,2,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Wind Harpy',3,9,2,34,4,4,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Water Harpy',3,8,3,35,3,3,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Goblin Archer',4,9,3,36,4,7,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Goblin Warrior',4,8,5,45,5,6,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Death Dog',5,10,3,35,4,7,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Miner Zombie',5,10,6,40,5,6,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Will',6,11,7,46,7,10,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Will Dawn',6,9,6,44,6,9,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Eye Red',7,10,8,50,8,14,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Rotten Eye',7,9,6,40,7,12,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Giant Snake',8,12,8,51,8,15,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Anaconda',8,13,9,55,9,16,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('WaterBall',9,13,5,40,9,14,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Fireball',9,13,9,54,9,17,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Poison Sand',9,10,9,54,9,17,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Pterodactyl',10,14,9,55,11,18,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Viper',10,13,8,54,10,17,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Ghost',11,17,12,69,11,21,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Clown',12,23,17,80,15,26,null,0);
    ...
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Blizzard',13,26,18,77,16,27,null,0);
    INSERT INTO monster(name,level,damage,defence,hp,givedxp,givedgold,equipDrop,equipDropChance) VALUES ('Immortal',13,25,18,79,16,28,null,0);
