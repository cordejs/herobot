...
export function hello(msg: Discord.Message) {
    ...
    const simpleGreetins: string[] =
        ["Hello", "Hi!!", "Hi there", "Hey Ooh", "Hey"];

    const greetingTimeMorning: string[] =
        ["Good Morning!", "Morning, sun shine",
    ...
    const greetingTimeAfternoon: string[] = [
        "Good afternoon!", "Good afternoon young master", "Happy afternoon"
    ];

    const greetingTimeNight: string[] = [
        "Good evining", "What a beautifull night, hum ?"
    ];

    const greetingTimeDawn: string[] = [
        "Hello my young. What are you doing up so late ?"
    ];
